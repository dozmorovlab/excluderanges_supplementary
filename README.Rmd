...
![License: GPL-3.0](https://img.shields.io/badge/license-GPL%203-blue.svg)
...
### [Tables](Tables)
**Table 1. Characteristics of the hg38 exclusion sets.** Total number of regions, average region width, number of regions overlapping gaps, and proportion of gap coverage.
...
set_flextable_defaults(
  ...
  big.mark = "",
  bg = "white"  # Set default background color to white
)

# Load Excel file (make sure the path is correct)
df <- read.csv("Tables/Table_1.csv", check.names = FALSE)

# Convert to a flextable and format it
table_flex <- flextable(df) |>
  separate_header(split = " | ", fixed = TRUE) |>
  fit_to_width(max_width = 6.5)

bg(table_flex, bg = "white", part = "all")
table_flex
```
